export const translations = {
  pl: {
    ...
    players: 'Gracze', configurationError: 'Nie można uruchomić PartyGame. Sprawdź konfigurację serwera.',
  },
  en: {
    ...
    players: 'Players', configurationError: 'PartyGame could not start. Check the server configuration.',
  },
};
