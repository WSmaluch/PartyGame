...
public sealed class ArchivedPackageRoomRestartTests
{
    ...
    private sealed class RoomFixture : IAsyncDisposable
    {
        ...
        private static PartyGame.Infrastructure.Media.StoredMediaResult ProfileMedia(Guid playerId, Guid assetId) => new($"test/profile/{playerId:N}/{assetId:N}/display.jpg", $"test/profile/{playerId:N}/{assetId:N}/thumbnail.jpg", 320, 320, 1, new string('0', 64));
    }
