...
The final 8.4 smoke test exercised both TrustedLanHttp startup paths against the published release DLL: no opt-in was rejected, while explicit LAN opt-in started successfully and completed authenticated CORS/rate-limit/header checks.
