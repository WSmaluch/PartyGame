...
STAGE="orchestration-validation"; wait_for_process orchestrator 420 "orchestrator completed" backend vite playwright xcodebuild || exit "$PRIMARY_EXIT_CODE"
...
wait_for_process xcodebuild 420 "XCUITest completed" backend vite playwright || exit "$PRIMARY_EXIT_CODE"
wait_for_process playwright 420 "Display Playwright completed" backend vite || exit "$PRIMARY_EXIT_CODE"
